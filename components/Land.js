...
import Movies from './Dropdown';


const Land = () => {
  // const handleClickScroll = (elementsID) => {
      ...
      <div className="absolute top-0 left-0 w-full h-full z-1 flex items-center justify-center mx-16">
        <div className="container mx-auto px-16 right-0">
          ...
          <div className='pt-8 flex flex-row'>
            <button 
              class="hover:text-[#bf1922] hover:border-[#bf1922] text-[#92131a] border border-[#92131a] py-2 px-4 rounded-full"
              // onClick={handleClickScroll("waitlist")}
              >
              Join the Waitlist
            </button>
            <Movies />
